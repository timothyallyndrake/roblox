# Cosmic Bloom — the pitch

**Display name:** Cosmic Bloom *(locked 2026-06-28)*  
**Slug:** `cosmic-bloom`  
**Read this one aloud** — kid-friendly version for family feedback
...
It’s a **cozy plant game on Roblox**.

- No fighting other players for your stuff
- No scary stuff — bright, friendly, all ages
- Play **solo** or with friends on the **same server** — everyone has **their own garden**
- **No trading** — no scams, just cozy vibes

---

## Your home base (two things)

### 1. Your garden

Open meadow under the stars. Plant seeds, grow **different kinds of bloom fruit**, pick when ripe.

Upgrade: **bigger garden**, **better soil**, **tools**, **display cases** for trophies (**3 cases max** — one per planet you unlock).

**Meadow decor** (from shops and events) looks cool **and** gives small buffs — like faster night growth or bigger harvests. You can only stack a few buff types so it stays fair.

Some plants love **moonlight**, some **sunshine**, some **both**.
...
- Mix **more at once**
- Mix **faster**
- **Splice luck** — better chance at rare mutations!

---

## The Bloomdex (grow ’em all)

Like a **Pokédex for plants** — but each collection is a **picture made of stars**.

| Collection | Shape | How many stars |
|------------|-------|----------------|
| **Little Slipper** | A cozy **slipper** made of stars | 6 |
| **Sun Rawr** | A **lion** made of stars (*rawr!*) | 8 |
| **Silver Weaver** | A **woven arc** of stars | 7 |
...
## The meadow hub (everyone goes here)
...
**Three planets at launch.** Each only eats **three fruit types**:

| Planet | When you unlock it | Fruits it eats |
|--------|-------------------|----------------|
| **Lumina** | Start | Glow Berry, Moon Melon, Nebula Pod |
| **Solara** | After Lumina **round 10** | Sun Peach, Star Carrot, Blaze Blossom |
| **Glimmer** | After Solara **round 15** | Dusk Lace, Twilight Pod, Eclipse Fern |
...
**Head start:** If you cross-breed a twilight plant **before** Glimmer unlocks, you can **grow and stockpile** that fruit — you just **can’t deliver to Glimmer** until Solara **round 15**. Prep pays off.
...
## Cosmic Spin (shared board — everyone watches!)

**One board for the whole server.** You tap to spin on your screen; the **server** decides what you win (fair and cheat-proof).

1. Board shows **`YourName is spinning…`** — several people can spin at once
2. When you **start** spinning, the game **remembers** which legendary was on the board and your **chances at that moment**
3. **Legendary win?** **Big show for everyone** on the server!
...
Like a **carnival wheel the whole server shares** — with fair rules so nobody gets cheated mid-spin.
...
When **new plants** get added, the **first player on your server** to discover one gets a shout-out, **Spin Tokens**, and their name highlighted on that Bloomdex page.
...
- Garden + Stellar Nursery
- Bloomdex with **3 star-map collections**, **mutations**, hover stars
- **3 planets**, **3 fruits each**, multi-line orders, planet unlock chain
- **Community Feed** every ~**30 min**
- Meteors, Cosmic Spin (earn-only extras), leaderboards, buff decor, display cases
- **Private meadow** option for invite-only play with people you trust

**After launch:** constellations in the night sky above your plot; more planets; seed rocket quests
...
## Locked for the studio

- **Cosmic Bloom** · Minimal / all ages · Cozy Fair (no paid random, no pay-to-win spins)

**Next:** economy tuning, then build in Roblox (Phase 06+).
